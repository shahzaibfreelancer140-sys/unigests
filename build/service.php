...
<body>
  <?php require_once './inc/nav.php';?>
    ...
    <section style="background-image: url(./assets/img/blurimg.png);"
        ...
        <div class="text-center  2xl:py-20 py-14 2xl:px-4 lg:px-10 px-5">
            ...
            <div class="2xl:pt-5 pt-3">
                   <p class="text-xl 2xl:leading-7  leading-6 font-normal text-[#333333]">Nous proposons une gamme
    ...
    <!-- Assurances Personnelles  section -->
    <!-- <section>
        <div
            class="2xl:grid 2xl:grid-cols-2 md:grid md:grid-cols-2 grid grid-cols-1 2xl:px-36 gap-12 lg:px-10 px-5 2xl:py-20 xl:py-20 py-10 bg-[#fcfcfc]">
            <div
                ...
                <div class="flex 2xl:gap-4 lg:gap-4 md:gap-4 gap-2">
                    <div>
                        <div>
                            <img src="./assets/img/shield.png" class="2xl:w-14 lg:w-10  w-12" alt="">
                        </div>
                    </div>
                    <div>
                        <div>
                            <h1 class="2xl:text-2xl  text-base 2xl:leading-8 leading-7 font-bold">Assurances
                                Personnelles
                            </h1>
                        </div>
                        <div class="2xl:pt-3 pt-1">
                            <p class="2xl:text-xl  text-xs 2xl:leading-9  leading-5 font-normal">
                                Protection complète pour votre patrimoine personnel</p>
                            <div class="flex 2xl:items-end lg:items-end items-center  2xl:gap-5 gap-2 2xl:pt-4 pt-1">
                                ...
                                <div>
                                    <p class="2xl:text-base text-xs leading-5 font-normal">Assurance habitation et
                                        responsabilité
                                        civile</p>
                                </div>
                            </div>
                            <div class="flex 2xl:items-end lg:items-end items-center 2xl:gap-5 gap-2 2xl:pt-4 pt-1">
                                ...
                                <div>
                                    <p class="2xl:text-base text-xs leading-5 font-normal">Assurance automobile tous
                                        risques</p>
                                </div>
                            </div>
                            <div class="flex 2xl:items-end lg:items-end items-center 2xl:gap-5 gap-2 2xl:pt-4 pt-1">
                                ...
                                <div>
                                    <p class="2xl:text-base text-xs leading-5 font-normal">Assurance voyage et loisirs
                                    </p>
                                </div>
                            </div>
                            <div class="flex 2xl:items-end lg:items-end items-center 2xl:gap-5 gap-2 2xl:pt-4 pt-1">
                                ...
                                <div>
                                    <p class="2xl:text-base text-xs leading-5 font-normal">Protection juridique</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div
                class="inline-block 2xl:px-10 px-5 2xl:py-10 py-5 bg-[#FCFCFC] rounded-lg border-2 border-[#ECEAE6] flex lg:mt-0 md:mt-0 mt-3">
                <div class="flex 2xl:gap-4 lg:gap-2 gap-4">
                    <div>
                        <div>
                            <img src="./assets/img/tab.png" class="2xl:w-14 lg:w-10 w-10" alt="">
                        </div>
                    </div>
                    <div>
                        <div>
                            <h1 class="2xl:text-2xl text-base 2xl:leading-8 leading-7 font-bold">Assurances Entreprises
                            </h1>
                        </div>
                        <div class="2xl:pt-3 pt-1">
                            <p class="2xl:text-xl  text-xs 2xl:leading-9 leading-5 font-normal">
                            ...
                            <div class="flex 2xl:items-end lg:items-end items-center 2xl:gap-5 gap-2 2xl:pt-4 pt-1">
                                ...
                                <div>
                                    <p class="2xl:text-base text-xs leading-5 font-normal">professionnelle, propriété et
                                    </p>
                                </div>
                            </div>
                            <div class="flex 2xl:items-end lg:items-end items-center 2xl:gap-5 gap-2 2xl:pt-4 pt-1">
                                ...
                                <div>
                                    <p class="2xl:text-base text-xs leading-5 font-normal">couverture commerciale pour
                                        les
                                    </p>
                                </div>
                            </div>
                            <div class="flex 2xl:items-end lg:items-end items-center 2xl:gap-5 gap-2 2xl:pt-4 pt-1">
                                ...
                                <div>
                                    <p class="2xl:text-base text-xs leading-5 font-normal">entreprises.
                                    </p>
                                </div>
                            </div>
            ...
            <div
                ...
                <div class="flex 2xl:gap-4 lg:gap-4 md:gap-4 gap-2">
                    <div>
                        <div>
                            <img src="./assets/img/dil.png" class="2xl:w-14 lg:w-10  w-12" alt="">
                        </div>
                    </div>
                    <div>
                        <div>
                        ...
                        <div class="2xl:pt-3 pt-1">
                            <p class="2xl:text-xl  text-xs 2xl:leading-9 leading-5 font-normal">
                                Couverture santé optimale pour vous et votre famille</p>
                            <div class="flex 2xl:items-end lg:items-end items-center 2xl:gap-5 gap-2 2xl:pt-4 pt-1">
                                <div>
                                    <i class="fa-regular fa-circle text-[#D7B242] text-[8px]"></i>
                                </div>
                                <div>
                                    <p class="2xl:text-base text-xs leading-5 font-normal">Assurance de base obligatoire
                                    </p>
                                </div>
                            </div>
                            <div class="flex 2xl:items-end lg:items-end items-center 2xl:gap-5 gap-2 2xl:pt-4 pt-1">
                                ...
                                <div>
                                    <p class="2xl:text-base text-xs leading-5 font-normal">Assurances complémentaires
                                    </p>
                                </div>
                            </div>
                            <div class="flex 2xl:items-end lg:items-end items-center 2xl:gap-5 gap-2 2xl:pt-4 pt-1">
                                ...
                                <div>
                                    <p class="2xl:text-base text-xs leading-5 font-normal">Optimisation des franchises
                                    </p>
                                </div>
                            </div>
                            <div class="flex 2xl:items-end lg:items-end items-center 2xl:gap-5 gap-2 2xl:pt-4 pt-1">
                                ...
                                <div>
                                    <p class="2xl:text-base text-xs leading-5 font-normal">Conseil personnalisé santé
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <div
                ...
                <div class="flex 2xl:gap-4 lg:gap-4 md:gap-4 gap-2">
                    <div>
                        <div>
                            <img src="./assets/img/dpeople.png" class="2xl:w-14 lg:w-10  w-10" alt="">
                        </div>
                    </div>
                    <div>
                        <div>
                            <h1 class="2xl:text-2xl text-base 2xl:leading-8 leading-7 font-bold">Prévoyance
                                Professionnelle
                            </h1>
                        </div>
                        <div class="2xl:pt-3 pt-1">
                            <p class="2xl:text-xl  text-xs 2xl:leading-9  leading-5 font-normal">
                                Prévoyance Professionnelle</p>
                            <div class="flex 2xl:items-end lg:items-end items-center 2xl:gap-5 gap-2 2xl:pt-4 pt-1">
                                <div>
                                    <i class="fa-regular fa-circle text-[#D7B242] text-[8px]"></i>
                                </div>
                                <div>
                                    <p class="2xl:text-base text-xs leading-5 font-normal">2ème pilier LPP</p>
                                </div>
                            </div>
                            <div class="flex 2xl:items-end lg:items-end items-center 2xl:gap-5 gap-2 2xl:pt-4 pt-1">
                                <div>
                                ...
                                <div>
                                    <p class="2xl:text-base text-xs leading-5 font-normal">3ème pilier lié et libre</p>
                                </div>
                            </div>
                            <div class="flex 2xl:items-end lg:items-end items-center 2xl:gap-5 gap-2 2xl:pt-4 pt-1">
                                <div>
                                ...
                                <div>
                                    <p class="2xl:text-base text-xs leading-5 font-normal">Optimisation fiscale
                                    </p>
                                </div>
                            </div>
                            <div class="flex 2xl:items-end lg:items-end items-center 2xl:gap-5 gap-2 2xl:pt-4 pt-1">
                                ...
                                <div>
                                    <p class="2xl:text-base text-xs leading-5 font-normal">Planification de retraite</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div
                ...
                <div class="flex 2xl:gap-4 lg:gap-4 md:gap-4 gap-2">
                    <div>
                        <div>
                            <img src="./assets/img/arrow.png" class="2xl:w-14 lg:w-10   w-12" alt="">
                        </div>
                    </div>
                    <div>
                        <div>
                            <h1 class="2xl:text-2xl  text-base 2xl:leading-8 leading-7 font-bold">Conseil et
                                Optimisation
                            </h1>
                        </div>
                        <div class="2xl:pt-3 pt-1">
                            <p class="2xl:text-xl text-xs 2xl:leading-9 leading-5 font-normal">
                                Analyse complète de votre portefeuille d'assurances</p>
                            <div class="flex 2xl:items-end lg:items-end items-center 2xl:gap-5 gap-2 2xl:pt-4 pt-1">
                                <div>
                                    <i class="fa-regular fa-circle text-[#D7B242] text-[8px]"></i>
                                </div>
                                <div>
                                    <p class="2xl:text-base text-xs leading-5 font-normal">Audit de vos couvertures
                                        existantes</p>
                                </div>
                            </div>
                            <div class="flex 2xl:items-end lg:items-end items-center 2xl:gap-5 gap-2 2xl:pt-4 pt-1">
                                ...
                                <div>
                                    <p class="2xl:text-base text-xs leading-5 font-normal">Détection des lacunes et
                                        doublons</p>
                                </div>
                            </div>
                            <div class="flex 2xl:items-end lg:items-end items-center 2xl:gap-5 gap-2 2xl:pt-4 pt-1">
                                ...
                                <div>
                                    <p class="2xl:text-base text-xs leading-5 font-normal">Négociation avec les
                                        compagnies
                                    </p>
                                </div>
                            </div>
                            <div class="flex 2xl:items-end lg:items-end items-center 2xl:gap-5 gap-2 2xl:pt-4 pt-1">
                                ...
                                <div>
                                    <p class="2xl:text-base text-xs leading-5 font-normal">Optimisation des primes</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div
                ...
                <div class="flex 2xl:gap-4 lg:gap-4 md:gap-4 gap-2">
                    <div>
                        <div>
                            <img src="./assets/img/music.png" class="2xl:w-14 lg:w-10  w-11" alt="">
                        </div>
                    </div>
                    <div>
                        <div>
                            <h1 class="2xl:text-2xl text-base 2xl:leading-8 leading-7 font-bold">Gestion des
                                Sinistres
                            </h1>
                        </div>
                        <div class="2xl:pt-3 pt-1">
                            <p class="2xl:text-xl text-xs 2xl:leading-9  leading-5 font-normal">
                                Accompagnement complet en cas de sinistre</p>
                            <div class="flex 2xl:items-end lg:items-end items-center 2xl:gap-5 gap-2 2xl:pt-4 pt-1">
                                <div>
                                    <i class="fa-regular fa-circle text-[#D7B242] text-[8px]"></i>
                                </div>
                                <div>
                                    <p class="2xl:text-base text-xs leading-5 font-normal">Déclaration et suivi des
                                        sinistres</p>
                                </div>
                            </div>
                            <div class="flex 2xl:items-end lg:items-end items-center 2xl:gap-5 gap-2 2xl:pt-4 pt-1">
                            ...
                            <div class="flex 2xl:items-end lg:items-end items-center 2xl:gap-5 gap-2 2xl:pt-4 pt-1">
                                ...
                                <div>
                                    <p class="2xl:text-base text-xs leading-5 font-normal">Expertise et évaluation des
                                        dommages
                                    </p>
                                </div>
                            </div>
                            <div class="flex 2xl:items-end lg:items-end items-center 2xl:gap-5 gap-2 2xl:pt-4 pt-1">
                                ...
                                <div>
                                    <p class="2xl:text-base text-xs leading-5 font-normal">Défense de vos intérêts</p>
                                </div>
                            </div>
                        </div>
                    </div>
  ...
  <section>
    <div class="2xl:px-36 lg:px-10 px-5 2xl:pt-20 pt-10 2xl:pb-20 pb-10 bg-white">
      <!-- <div class="text-center">
        <div>
          <h1 class="lg:text-3xl  md:text-3xl text-2xl leading-9 font-bold">Nos Services</h1>
        </div>
        <div class="pt-5">
          <p class="text-xl lg:leading-7  leading-6 font-normal">Nous proposons une gamme
            complète de services dans le domaine de l’assurance tant
            pour les
            entreprises que <br class="lg:block hidden"> pour les privés afin de répondre avec précision à vos besoins
            et à votre situation personnelle.
...
<div class="flex 2xl:items-end lg:items-end items-center 2xl:gap-5 gap-2 2xl:pt-4 pt-1">
  ...
  <!-- section end -->
    ...
    <section>
        <div class="lg:pt-[60px] pt-10 pb-10 2xl:px-36 lg:px-10 px-5 bg-[#fcfcfc]">
            <div class="text-center">
                <div>
                    <h1 class="lg:text-3xl  md:text-3xl text-2xl leading-9 font-bold text-[#333333]">
                        Nos Partenaires
                ...
                <div class="2xl:pt-5 pt-3">
                    <p class="text-xl lg:leading-7  leading-6 font-normal text-[#333333]">Nous sélectionnons
                        les meilleurs partenaires afin de <br class="lg:block hidden"> vous offrir des solutions
                        fiables,
  ...
  <section>
    ...
    <div class="2xl:px-36 lg:px-10 px-5 2xl:pt-20 pt-10 2xl:pb-20 pb-10 overflow-hidden">
      <div class="slider flex items-center justify-between 2xl:gap-60 lg:gap-20 gap-12">
        ...
        <div><img src="./assets/img/allianz-logo.png" class="2xl:w-60 md:w-32 w-28" alt=""></div>
        <div><img src="./assets/img/helsana-logo.png" class="2xl:w-60 md:w-32 w-28" alt=""></div>
        <div><img src="./assets/img/logo-AXA.png" class="2xl:w-48 md:w-28 w-24" alt=""></div>
        <div><img src="./assets/img/resize-17597355541943316238mobiliere3.png" class="2xl:w-48 md:w-32 w-28" alt="">
        </div>
        <div><img src="./assets/img/Rentes Genevoises.png" class="2xl:w-60 md:w-32 w-28" alt=""></div>
        <div><img src="./assets/img/Solida.png" class="2xl:w-60 md:w-32 w-28" alt=""></div>
        <div><img src="./assets/img/Tellco.png" class="2xl:w-60 md:w-32 w-28" alt=""></div>
      </div>
    </div>

  </section>
  <!-- end slider img section  -->
    <hr>
